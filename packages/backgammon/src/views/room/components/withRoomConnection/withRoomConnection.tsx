...
export default function withRoomConnection<Props>(
    WrappedComponent: React.ComponentType<Props>
) {
    return function WithRoomConnection(props: Props): React.ReactElement {
        const params = useParams<{ id: string }>();
        const connectionStatus = useConnection(
            mergePath(REACT_APP_SOCKET_URL, params.id)
        );
