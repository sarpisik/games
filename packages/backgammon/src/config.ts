...
export const SIDEBAR_FONT_SIZE = 0.017;
...
const RIGHT_BLOCK_TRIANGLE_END_X = 29.5 + TRIANGLE_WIDTH;
...
const BOTTOM_RIGHT_TRIANGLES_START = RIGHT_BLOCK_TRIANGLE_END_X + 1; // negative direction.
...
export const OFFSETS = {
    ...
    POINT_SIZE,
    POINT_TOP_START_Y: 0.8,
    POINT_BOTTOM_START_Y: 24.8,
