...
const RIGHT_BLOCK_TRIANGLE_END_X = 27 + TRIANGLE_WIDTH;
...
export const OFFSETS = {
    ...
    // point
    POINT_SIZE: TRIANGLE_WIDTH,
    POINT_BOTTOM_START_Y: BOTTOM_BLOCK_START_Y - TRIANGLE_WIDTH * 1.8,
